    ...
    for (int nHost = 1; nHost <= 2; nHost++)
    {
        ...
        if (nHost == 1)
        {
            ...
            pszGet = "GET / HTTP/1.1\r\n"
                     ...
                     "User-Agent: coincreationservicecoin\r\n"
                     "Connection: close\r\n"
                     "\r\n";
...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("coincreationservicecoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("coincreationservicecoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("coincreationservicecoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "coincreationservicecoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
	{"138.197.32.89", "138.197.32.89"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("coincreationservicecoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("coincreationservicecoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("coincreationservicecoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("coincreationservicecoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. coincreationservicecoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("coincreationservicecoin-start");
