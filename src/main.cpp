...
const string strMessageMagic = "coincreationservicecoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if(pindexBest->nHeight >= 2 && pindexBest->nHeight+1 <= 100)
    {
        nSubsidy = 0 * COIN;
    }
...
const int DAILY_BLOCKCOUNT =  144;
...
static const int64_t nTargetTimespan = 5 * 60;  // 5 min
//
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "coincreationservicecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Kraken Gets MBA Students To Choose Between Bitcoin and Ether 28/11/2016";
        CTransaction txNew;
        txNew.nTime = 1480339541;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xcdf162dcac8dcbd64c378faa8cfa28d17c3af87875f63360f2ea0f61a14e0d52"));
        block.print();
