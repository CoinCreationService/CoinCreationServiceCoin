TEMPLATE = app
TARGET = coincreationservicecoin-qt
VERSION = 1.0.0
...
win32:QMAKE_LFLAGS *= -static-libgcc -static-libstdc++ -lpthread -L libwinpthread-1.dll
...
QMAKE_CXXFLAGS_WARN_ON = -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -static -Wstack-protector
...
macx:ICON = src/qt/res/icons/coincreationservicecoin.icns
macx:TARGET = "coincreationservicecoin-Qt"
